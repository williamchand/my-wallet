CREATE DATABASE  IF NOT EXISTS `wallet` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `wallet`;
...
CREATE TABLE `wallet_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `composite` (`wallet_id`,`category_id`)
...
INSERT INTO `wallet_category` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3),(7,3,3),(8,4,3),(9,5,2),(11,6,1),(10,6,2);
