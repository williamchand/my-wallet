...
func (_m *Usecase) Fetch(ctx context.Context, cursor string, num int64) ([]*models.Wallet, string, error) {
...
func (_m *Usecase) GetByID(ctx context.Context, id int64) (*models.Wallet, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetByTitle(ctx context.Context, title string) (*models.Wallet, error) {
...
func (_m *Usecase) Store(_a0 context.Context, _a1 *models.Wallet) error {
...
func (_m *Usecase) Update(ctx context.Context, ar *models.Wallet) error {
