...
import models "github.com/williamchand/my-wallet/models"
...
func (_m *Repository) Fetch(ctx context.Context, cursor string, num int64) ([]*models.Wallet, string, error) {
	ret := _m.Called(ctx, cursor, num)

	var r0 []*models.Wallet
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) []*models.Wallet); ok {
...
func (_m *Repository) GetByID(ctx context.Context, id int64) (*models.Wallet, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetByTitle(ctx context.Context, title string) (*models.Wallet, error) {
...
func (_m *Repository) Store(ctx context.Context, a *models.Wallet) error {
	ret := _m.Called(ctx, a)
...
func (_m *Repository) Update(ctx context.Context, ar *models.Wallet) error {
